...
const authRepository = require('../repositories/mobile/authRepository');
...
class AuthService {
  ...
  async register(userData) {
    ...
    try {
      const existingUser = await authRepository.findUserByEmailForRegistration(email);
  ...
  async login(loginData, deviceInfo = {}) {
    ...
    try {
      ...
      await authRepository.updateUserLastLogin(user.user_id, new Date().toISOString());
