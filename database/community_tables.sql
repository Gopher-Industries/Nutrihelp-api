-- Community Database Tables for Nutrihelp API
-- This file contains the SQL schema for community features
...
-- Community Bookmarks Table (for future use)
...
-- Community Shares Table (for future use)
