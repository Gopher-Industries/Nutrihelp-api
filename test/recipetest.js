  ...
  it('should return 400, Recipe parameters are missing', (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body).to.have.property('error').that.equals('Recipe parameters are missed');
        done();
      });
  });
});
  ...
  it('should return 400, User Id is required', (done) => {
    chai
      ...
      .end((err, res) => {
        if (err) return done(err);
        expect(res).to.have.status(400);
        expect(res.body).to.have.property('error').that.equals('User Id is required');
        done();
      });
  });
});
  ...
  it('should return 404, Recipes not found', (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body).to.have.property('error').that.equals('Recipes not found');
        done();
      });
  });
});
  ...
  it('should return 400, User Id or Recipe Id is required', (done) => {
    chai
      ...
      .end((err, res) => {
        if (err) return done(err);
        expect(res).to.have.status(400);
        expect(res.body).to.have.property('error').that.equals('User Id or Recipe Id is required');
        done();
      });
  });
});
