  ...
  it('should return 200, Update user profile Successful', (done) => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body[0]).to.have.property('first_name', req.first_name);
        expect(res.body[0]).to.have.property('last_name', req.last_name);
        expect(res.body[0]).to.have.property('email', req.email);
        expect(res.body[0]).to.have.property('contact_number', req.contact_number);
        done();
      });
  });
