...
const AI_CHAT_URL = process.env.AI_CHAT_URL || "https://localhost:8000/ai-model/chatbot/chat";
const AI_ADD_URL = process.env.AI_ADD_URL || "https://localhost:8000/ai-model/chatbot/add_urls";
...
const getChatResponse = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      const ai_response = await fetchAi(AI_CHAT_URL, {
        method: "POST",
        headers: {
...
const addURL = async (req, res) => {
  ...
  try {
    ...
    try {
      // Send request to API server and get response
      const ai_response = await fetchAi(`${AI_ADD_URL}?urls=${encodeURIComponent(urls)}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        }
