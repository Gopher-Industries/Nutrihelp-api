...
// Legacy appointment routes
router.route('/')
  .post(authenticateToken, sanitizeInput, appointmentValidator, validate, appointmentController.saveAppointment)
  .get(authenticateToken, appointmentController.getAppointments);

// Structured appointment routes used by newer clients
router.route('/v2')
  .post(authenticateToken, sanitizeInput, appointmentValidator, validate, appointmentController.saveAppointmentV2)
  .get(authenticateToken, appointmentController.getAppointmentsV2);

router.route('/v2/:id')
  .put(authenticateToken, sanitizeInput, appointmentValidator, validate, appointmentController.updateAppointment)
  .delete(authenticateToken, appointmentController.delAppointment);
